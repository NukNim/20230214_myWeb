DROP TABLE KH_BOARD CASCADE CONSTRAINTS;
...
BOARD_REF NUMBER, -- 원글일때는 자기번호, 답글일 때 참조하는 원글 번gh
BOARD_REPLY_SEQ NUMBER DEFAULT 0, -- 답글의 순번
BOARD_READCOUNT NUMBER DEFAULT 0, -- 조회수
CONSTRAINT PK_KH_BOARD PRIMARY KEY (BOARD_NUM),
CONSTRAINT FK_KH_BOARD_WRITER FOREIGN KEY (BOARD_WRITER) REFERENCES TEST_MEMBER (ID) ON DELETE SET NULL,
CONSTRAINT FK_KH_BOARD_REF FOREIGN KEY (BOARD_REF) REFERENCES KH_BOARD (BOARD_NUM) ON DELETE CASCADE
);